...
export class GameModeMenuScene extends Phaser.Scene {
  ...
  createUI() {
    ...
    this.createModeButton('🌊 CASCADE MODE', 'Chain reactions! Items fall and create combos!', screenHeight * 0.56, 'cascade', 0x1E90FF)
    this.createModeButton('🏆 ZEN MODE', 'Relax! No moves/time limit!', screenHeight * 0.68, 'zen', 0x32CD32)
